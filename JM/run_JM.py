...
parser = argparse.ArgumentParser(description='JM Model')
parser.add_argument('--data', type=str, default='../data/title', # /input
...
parser.add_argument('--save', type=str,  default='../model_files/JM/JM_model.pt')
...
# print('train:',corpus.train,corpus.train.size())
# print('test:',corpus.test,corpus.test.size())
# print('val:',corpus.valid,corpus.valid.size())
...
ntokens = 10 # 10000
model = JM.JModel(ntokens, args.emsize, args.nhid, args.nlayers, args.dropout)
